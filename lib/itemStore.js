...
const getRedisClient = stub => {
    ...
    return R.merge ( client, {
        smembers: ( parms, callback ) => {
            return client.smembers ( parms, wrapCallback ( callback ) );
        },
        sadd: ( parms, callback ) => {
            return client.sadd ( parms, wrapCallback ( callback ) );
        },
        lrange: ( parms, callback ) => {
            return client.lrange ( parms, wrapCallback ( callback ) );
        },
        rpush: ( parms, callback ) => {
            return client.rpush ( parms, wrapCallback ( callback ) );
        },
        zscore: ( parms, callback ) => {
            return client.zscore ( parms, wrapCallback ( callback ) );
        },
