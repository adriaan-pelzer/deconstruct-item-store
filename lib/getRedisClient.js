...
const getRedisConfigs = env => {
    ...
    const read_hosts = ( env.READ_REDIS_HOSTS || env.READ_REDIS_HOSTS_FO ) ? R.map ( R.trim, R.concat ( env.READ_REDIS_HOSTS.split ( ',' ) || [], env.READ_REDIS_HOSTS_FO.split ( ',' ) || [] ) ) : [ write_host ];
    const read_ports = ( env.READ_REDIS_PORTS || env.READ_REDIS_PORTS_FO ) ? R.map ( R.trim, R.concat ( env.READ_REDIS_PORTS.split ( ',' ) || [], env.READ_REDIS_PORTS_FO.split ( ',' ) || [] ) ) : [ write_port ];
